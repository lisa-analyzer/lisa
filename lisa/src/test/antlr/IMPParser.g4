...
arg: literal | IDENTIFIER | THIS | fieldAccess | arrayAccess | methodCall;
...
forDeclaration: init=assignment? SEMI condition=expression SEMI post=assignment?;
...
fieldDeclaration : name=IDENTIFIER SEMI;
constructorDeclaration: name=IDENTIFIER pars=formals code=block;
methodDeclaration: name=IDENTIFIER pars=formals code=block;

/*
 * CLASS
 */
unit: CLASS name=IDENTIFIER (EXTENDS superclass=IDENTIFIER)? LBRACE declarations=memberDeclarations RBRACE; 
