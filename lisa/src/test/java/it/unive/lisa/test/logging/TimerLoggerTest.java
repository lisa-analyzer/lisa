...
public class TimerLoggerTest {
	...
	public void testSupplier() {
		Integer result = TimerLogger.execSupplier(logger, Level.INFO, TimeFormat.MILLIS, "Test supplier logging", this::supplier);
	...
	public void testFunction() {
		for (double d = 0; d < 3; d++) {
			Integer result = TimerLogger.execFunction(logger, Level.INFO, TimeFormat.MILLIS, "Test function logging", v -> function(v), d);
