...
public class StringConcat extends NativeCFG {
	 ...
	 */
	public StringConcat(CompilationUnit stringUnit) {
		super(new CFGDescriptor(stringUnit, true, "concat", StringType.INSTANCE,
	 ...
	 * @author <a href="mailto:luca.negrini@unive.it">Luca Negrini</a>
	 */
	public static class IMPStringConcat extends BinaryNativeCall implements PluggableStatement {
		...
		public IMPStringConcat(CFG cfg, String sourceFile, int line, int col, Expression left,
				Expression right) {
			super(cfg, new SourceCodeLocation(sourceFile, line, col), "concat", StringType.INSTANCE, left, right);
		}
		...
		protected <A extends AbstractState<A, H, V>,
			...
			return rightState.smallStepSemantics(
					new BinaryExpression(getRuntimeTypes(), leftExp, rightExp, BinaryOperator.STRING_CONCAT),
					original);
		}
	}
}
