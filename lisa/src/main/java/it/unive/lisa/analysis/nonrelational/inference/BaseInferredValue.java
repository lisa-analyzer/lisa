 ...
 * {@link InferredValue#eval(it.unive.lisa.symbolic.SymbolicExpression, it.unive.lisa.analysis.FunctionalLattice)}
...
public abstract class BaseInferredValue<T extends BaseInferredValue<T>> extends BaseLattice<T>
	...
	@Override
	public final Satisfiability satisfies(ValueExpression expression, InferenceSystem<T> environment) {
	...
	@Override
	public final T eval(ValueExpression expression, InferenceSystem<T> environment) {
		if (expression instanceof Identifier)
