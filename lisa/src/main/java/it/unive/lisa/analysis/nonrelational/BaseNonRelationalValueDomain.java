...
public abstract class BaseNonRelationalValueDomain<T extends BaseNonRelationalValueDomain<T>> extends BaseLattice<T>
	 ...
	 * {@code operator} to two expressions whose abstract values are {@code left},
	 * and {@code right}. This method returns an instance of {@link Satisfiability}. 
	 ...
	 * {@code middle} and {@code right}. This method returns an instance of {@link Satisfiability}. 
