...
public interface DataflowElement<D extends DataflowDomain<D, E>, E extends DataflowElement<D, E>>
	...
	/**
	 * The dataflow <i>gen</i> operation, yielding the dataflow elements that are
	 * generated by the assignment of the given {@code expression} to the given
	 * {@code id}.
	 * 
	...
	/**
	 * The dataflow <i>kill</i> operation, yielding the {@link Identifier}s that are
	 * killed by the assignment of the given {@code expression} to the given
	 * {@code id}.
	 * 
	 * @param id         the {@link Identifier} being assigned
	 * @param expression the expressions that is being assigned to {@code id}
