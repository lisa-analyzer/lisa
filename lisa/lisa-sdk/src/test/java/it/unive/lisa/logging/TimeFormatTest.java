...
public class TimeFormatTest {
	...
	public void testNanos() {
		loopRunner(l -> TimeUnit.NANOSECONDS.toNanos(l) + UNIT_NANOS, l -> NANOS.format(l));
	}

	@Test
	public void testMillis() {
		loopRunner(l -> TimeUnit.NANOSECONDS.toMillis(l) + UNIT_MILLIS, l -> MILLIS.format(l));
	}

	@Test
	public void testSeconds() {
		loopRunner(l -> TimeUnit.NANOSECONDS.toSeconds(l) + UNIT_SECONDS, l -> SECONDS.format(l));
	}

	@Test
	public void testMinutes() {
		loopRunner(l -> TimeUnit.NANOSECONDS.toMinutes(l) + UNIT_MINUTES, l -> MINUTES.format(l));
	}

	@Test
	public void testHours() {
		loopRunner(l -> TimeUnit.NANOSECONDS.toHours(l) + UNIT_HOURS, l -> HOURS.format(l));
	}
