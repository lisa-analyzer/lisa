...
public class StringReplaceFirstTest {
	...
	public void allThreeStringArgumentsYieldString() {
		assertEquals(
				...
				StringReplaceFirst.INSTANCE.typeInference(ts, string, string, string));
	}

	@Test
	public void aNonStringFirstArgumentYieldsEmpty() {
		assertTrue(StringReplaceFirst.INSTANCE.typeInference(ts, other, string, string).isEmpty());
	}

	@Test
	public void aNonStringSecondArgumentYieldsEmpty() {
		assertTrue(StringReplaceFirst.INSTANCE.typeInference(ts, string, other, string).isEmpty());
	}

	@Test
	public void aNonStringThirdArgumentYieldsEmpty() {
		assertTrue(StringReplaceFirst.INSTANCE.typeInference(ts, string, string, other).isEmpty());
	}
