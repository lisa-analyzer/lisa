 ...
 * {@link UnaryExpression} using this operator computes the radians conversion
 * of that value.<br>
 * <br>
...
public class NumericToRadians
	 ...
	 */
	public static final NumericToRadians INSTANCE = new NumericToRadians();
