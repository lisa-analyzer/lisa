 ...
 * character is lowercase, {@code false} otherwise.<br>
 * <br>
...
public class CharacterIsLowerCase
	 ...
	 */
	public static final CharacterIsLowerCase INSTANCE = new CharacterIsLowerCase();
	 ...
	 */
	protected CharacterIsLowerCase() {
	}
