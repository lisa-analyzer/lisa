 ...
 * character is either a letter or a digit, {@code false} otherwise.<br>
 * <br>
 ...
 */
public class CharacterIsLetterOrDigit
		implements
		UnaryOperator {
	 ...
	 */
	public static final CharacterIsLetterOrDigit INSTANCE = new CharacterIsLetterOrDigit();
	 ...
	 */
	protected CharacterIsLetterOrDigit() {
	}
