...
import it.unive.lisa.type.common.UInt64;

/**
 * A 64-bit unsigned {@link Literal} representing a constant integral value.
 * Instances of this literal have a {@link UInt64} static type. Internally, the
...
public class UInt64Literal extends Literal<Long> {
	 ...
	 */
	public UInt64Literal(ImplementedCFG cfg, CodeLocation location, long value) {
		super(cfg, location, value, UInt64.INSTANCE);
	}
}
