...
/**
 * An event signaling the start of the fixpoint computation for a given CFG in
 ...
 */
public class CFGFixpointStart<A extends AbstractLattice<A>>
		extends
		Event
		implements
