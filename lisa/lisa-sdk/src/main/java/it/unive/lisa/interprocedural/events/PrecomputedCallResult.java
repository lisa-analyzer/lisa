...
/**
 * An event signaling that the analysis found an existing compatible result for
 * a given call.
 * 
 ...
 */
public class PrecomputedCallResult<A extends AbstractLattice<A>>
		extends
		Event
		implements
	 ...
	 * Builds the event.
	 * 
	 * @param call   the call whose state has been found
	 ...
	 * @param state  the found state
	 */
	public PrecomputedCallResult(
			CFGCall call,
			ScopeId<A> id,
	...
	/**
	 * Yields the call whose state has been found.
	 * 
	 * @return the call
	 */
