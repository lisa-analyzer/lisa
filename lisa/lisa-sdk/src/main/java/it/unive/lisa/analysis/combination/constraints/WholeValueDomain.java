...
/**
 * A {@link BaseNonRelationalValueDomain} that can be employed in a
 * {@link WholeValueAnalysis} to model the concrete values of a given type.
 * Different data types can be modeled by different implementations of this
 * interface, that communicate together through <i>constraints</i> (i.e.,
 * {@link BinaryExpression}s having a constant on the left-hand side and an
 * expression on the right-hand side).
 * 
 * @param <D> the concrete type of this domain
 */
public interface WholeValueDomain<D extends WholeValueDomain<D>>
	 ...
	 * by this domain element. The constraints must be definite, as in with each
	...
	/**
	 * Generates a new instance of this domain that overapproximates the given
	 ...
	 *                        generated
	 * 
	 * @return a new instance of this domain that overapproximates the given
	 *             constraints
	 * 
	 * @throws SemanticException if an error occurs during the computation
	 */
