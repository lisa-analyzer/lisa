 ...
 * character can be used in an identifier, {@code false} otherwise.<br>
 * <br>
 ...
 */
public class CharacterIsIdentifierPart
		implements
		UnaryOperator {
	 ...
	 */
	public static final CharacterIsIdentifierPart INSTANCE = new CharacterIsIdentifierPart();
	 ...
	 */
	protected CharacterIsIdentifierPart() {
	}
