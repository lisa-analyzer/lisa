...
/**
 * An event signaling that the comparison operation between subsequent
 * abstractions for the same Statement has been performed during a fixpoint
 * computation.
 * 
 ...
 */
public class LeqPerformed<A extends AbstractLattice<A>>
		extends
		Event
		implements
		FixpointEvent {
