 ...
 * character is a letter (as defined by the Unicode standard), {@code false}
 * otherwise.<br>
 * <br>
...
public class CharacterIsLetter
	 ...
	 */
	public static final CharacterIsLetter INSTANCE = new CharacterIsLetter();
