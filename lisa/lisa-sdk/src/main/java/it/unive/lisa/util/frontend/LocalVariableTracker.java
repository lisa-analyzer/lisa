...
public class LocalVariableTracker {
    ...
    private static class LocalVariable {
        ...
        private LocalVariable(CodeLocation location, Statement scopeStart, Annotations annotations) {
    ...
    public LocalVariableTracker(CFG cfg, CodeMemberDescriptor descriptor) {
    ...
    public void exitScope(Statement closing) {
    ...
    public void addVariable(String name, Statement definition, Annotations annotations) {
