 ...
 * first argument is a suffix of the one of the second argument.<br>
 * <br>
...
public class StringIsSuffixOf
	 ...
	 */
	public static final StringIsSuffixOf INSTANCE = new StringIsSuffixOf();
