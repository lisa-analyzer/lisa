...
public class VisitOnceFIFOWorkingSet<E>
	...
	@Override
	public VisitOnceFIFOWorkingSet<E> mk() {
		return new VisitOnceFIFOWorkingSet<>();
	}

	/**
	 * Builds an empty working set.
	 */
	public VisitOnceFIFOWorkingSet() {
		ws = new LinkedList<>();
		seen = new HashSet<>();
	}
	...
	public boolean equals(
		...
		if (getClass() != obj.getClass())
			return false;
		VisitOnceFIFOWorkingSet<?> other = (VisitOnceFIFOWorkingSet<?>) obj;
		if (seen == null) {
			if (other.seen != null)
				return false;
