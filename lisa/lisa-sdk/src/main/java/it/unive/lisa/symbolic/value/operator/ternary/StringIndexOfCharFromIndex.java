 ...
 * using this operator computes the index <i>of the first occurrence</i> of the
 * second argument inside the string of the first argument happening after the
 * position of the third argument, producing {@code -1} if no occurrence can be
 * found.<br>
 * <br>
 ...
 */
public class StringIndexOfCharFromIndex
		implements
		TernaryOperator {
	 ...
	 */
	public static final StringIndexOfCharFromIndex INSTANCE = new StringIndexOfCharFromIndex();
