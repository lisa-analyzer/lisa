 ...
 * corresponding to the first argument's string where the first substring
 * matching the second argument's regex has been replaced with the third
 * argument's string.<br>
 * Note that:
 * <ul>
...
public class StringReplaceFirst
	 ...
	 */
	public static final StringReplaceFirst INSTANCE = new StringReplaceFirst();
