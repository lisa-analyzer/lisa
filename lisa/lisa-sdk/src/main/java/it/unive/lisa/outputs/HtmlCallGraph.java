 ...
 */
public class HtmlCallGraph<A extends AbstractLattice<A>, D extends AbstractDomain<A>>
		implements
		LiSAOutput {

	private static final Logger LOG = LogManager.getLogger(HtmlCallGraph.class);
	...
	public void dump(
		...
		try {
			fileManager.mkHtmlFile(filename, writer -> graph.toHtml(true, "call information").dump(writer));
