 ...
 * {@link UnaryExpression} using this operator computes the sine of that
 * value.<br>
 * <br>
...
public class NumericSin
	 ...
	 */
	public static final NumericSin INSTANCE = new NumericSin();
