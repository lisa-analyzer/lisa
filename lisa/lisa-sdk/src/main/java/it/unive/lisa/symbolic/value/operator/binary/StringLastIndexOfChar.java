 ...
 * <i>of the last occurrence</i> of the second argument inside the string of the
 * first argument, producing {@code -1} if no occurrence can be found.<br>
 * <br>
 ...
 */
public class StringLastIndexOfChar
		implements
		BinaryOperator {
	 ...
	 */
	public static final StringLastIndexOfChar INSTANCE = new StringLastIndexOfChar();
	 ...
	 */
	protected StringLastIndexOfChar() {
	}
