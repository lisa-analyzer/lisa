...
/**
 * An event signaling the start of an assumption of a symbolic expression by a
 * domain taking part in the analysis.
 * 
 * @author <a href="mailto:luca.negrini@unive.it">Luca Negrini</a>
 * 
 * @param <L> the type of {@link Lattice} produced by the domain
 */
public class DomainAssumeStart<L extends Lattice<L>>
		extends
		Event
		implements
		DomainEvent,
	...
	public String getTarget() {
		return domain.getSimpleName() + ": Assume of " + expression;
	}
