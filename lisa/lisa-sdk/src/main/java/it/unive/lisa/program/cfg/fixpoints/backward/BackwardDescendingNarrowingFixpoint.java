...
public class BackwardDescendingNarrowingFixpoint<A extends AbstractLattice<A>,
	 ...
	 * be built throug the
	 * {@link #BackwardDescendingNarrowingFixpoint(CFG, boolean, InterproceduralAnalysis, FixpointConfiguration)}
	 * constructor or the
	...
	public boolean equals(
		...
		if (getClass() != obj.getClass())
			return false;
		BackwardDescendingNarrowingFixpoint<?, ?> other = (BackwardDescendingNarrowingFixpoint<?, ?>) obj;
		if (config == null) {
