 ...
 */
public class OptimizedBackwardAscendingFixpoint<A extends AbstractLattice<A>, D extends AbstractDomain<A>>
		extends
	 ...
	 */
	public OptimizedBackwardAscendingFixpoint() {
	...
	public BackwardCFGFixpoint<A, D> asUnoptimized() {
		return new BackwardAscendingFixpoint<>();
	}
	...
	public int hashCode() {
		...
		result = prime * result + ((lubs == null) ? 0 : lubs.hashCode());
	...
	public boolean equals(
		...
		if (getClass() != obj.getClass())
			return false;
		OptimizedBackwardAscendingFixpoint<?, ?> other = (OptimizedBackwardAscendingFixpoint<?, ?>) obj;
		if (config == null) {
		...
		if (lubs == null) {
			if (other.lubs != null)
				return false;
		} else if (!lubs.equals(other.lubs))
			return false;
