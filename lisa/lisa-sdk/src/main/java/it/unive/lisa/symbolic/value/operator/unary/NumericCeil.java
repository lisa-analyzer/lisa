 ...
 * {@link UnaryExpression} using this operator computes the ceil of that
 * value.<br>
 * <br>
...
public class NumericCeil
	 ...
	 */
	public static final NumericCeil INSTANCE = new NumericCeil();
