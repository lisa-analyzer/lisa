...
/**
 * An edge that connects the end of a finally block to the statement to execute
 * after it. The control flow is transferred from the finally block, merging a
 * trace with a given index to distinguish between different paths that may lead
 * to the same finally block.
 * 
 * @author <a href="mailto:luca.negrini@unive.it">Luca Negrini</a>
 */
public class EndFinallyEdge extends Edge {
