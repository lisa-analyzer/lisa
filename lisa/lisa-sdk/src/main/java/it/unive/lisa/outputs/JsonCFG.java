 ...
 */
public class JsonCFG extends JsonGraph<Statement, Edge, CFG> {

	private JsonCFG(String title) {
		super(title, new CFGLegend().graph);
	}

	/**
	 * Builds a {@link JsonCFG} from a {@link CFG}. The label of a node
	 ...
	 */
	public static JsonCFG fromCFG(CFG source, String title, Function<Statement, String> labelGenerator) {
		JsonCFG graph = new JsonCFG(title);
