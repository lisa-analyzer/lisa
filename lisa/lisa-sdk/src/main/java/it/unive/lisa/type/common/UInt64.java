...
/**
 * An unsigned 64-bit integral {@link NumericType}. The only singleton instance of
 ...
 */
public final class UInt64 implements NumericType {
	...
	@Override
	public int hashCode() {
		return UInt64.class.getName().hashCode();
	}
