 ...
 */
public class OptimizedBackwardDescendingNarrowingFixpoint<A extends AbstractLattice<A>,
	 ...
	 * be built throug the
	 * {@link #OptimizedBackwardDescendingNarrowingFixpoint(CFG, boolean, InterproceduralAnalysis, FixpointConfiguration)}
	 * constructor or the
	...
	public ForwardCFGFixpoint<A, D> asForward() {
		return new OptimizedForwardDescendingNarrowingFixpoint<>(hotspots);
	}
