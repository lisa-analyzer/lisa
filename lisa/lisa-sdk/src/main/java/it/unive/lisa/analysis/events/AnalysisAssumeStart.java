...
/**
 * An event signaling the start of an assumption of a symbolic expression during
 * the analysis.
 * 
 ...
 */
public class AnalysisAssumeStart<A extends AbstractLattice<A>>
		extends
		Event
		implements
		AnalysisEvent,
