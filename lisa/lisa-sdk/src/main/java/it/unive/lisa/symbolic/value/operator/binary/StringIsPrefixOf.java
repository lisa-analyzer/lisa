 ...
 * first argument is a prefix of the one of the second argument.<br>
 * <br>
...
public class StringIsPrefixOf
	 ...
	 */
	public static final StringIsPrefixOf INSTANCE = new StringIsPrefixOf();
