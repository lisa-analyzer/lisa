 ...
 * {@link UnaryExpression} using this operator computes the cosine of that
 * value.<br>
 * <br>
...
public class NumericCos
	 ...
	 */
	public static final NumericCos INSTANCE = new NumericCos();
