 ...
 */
public class JSONCallGraph<A extends AbstractLattice<A>, D extends AbstractDomain<A>>
		implements
		LiSAOutput {

	private static final Logger LOG = LogManager.getLogger(JSONCallGraph.class);
	...
	public void dump(
		...
		String filename = "callgraph.graph";
		try {
