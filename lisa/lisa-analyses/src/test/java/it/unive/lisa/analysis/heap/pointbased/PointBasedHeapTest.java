...
public class PointBasedHeapTest {
	...
	private final AllocationSite alloc1 = new DynamicAllocationSite(untyped, loc1.getCodeLocation(), true, loc1);
	private final AllocationSite alloc2 = new DynamicAllocationSite(untyped, loc2.getCodeLocation(), true, loc2);
