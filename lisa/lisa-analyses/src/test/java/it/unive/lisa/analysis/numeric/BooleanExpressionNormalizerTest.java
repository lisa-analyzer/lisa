...
/**
 * Test di unità per {@link BooleanExpressionNormalizer}. Copre normalizzazione
 * di operatori logici, confronti, negazioni e casi specifici per tipi interi.
 * 
...
public class BooleanExpressionNormalizerTest {
	...
	private static boolean isZeroConst(
	...
	private static void assertIsAdd(
			BinaryExpression e) {
		assertTrue("Expected addition, got: " + e.getOperator(), e.getOperator() instanceof NumericNonOverflowingAdd);
	}

	private static void assertIsSub(
			BinaryExpression e) {
		assertTrue("Expected subtraction, got: " + e.getOperator(),
				e.getOperator() instanceof NumericNonOverflowingSub);
	}

	private static void assertIsNegXPlusCLeZero(
	...
	public void addZeroNormalization() throws SemanticException { // ERROR
		// fails with:
		// it.unive.lisa.analysis.SemanticException: ComparisonGt not handled
		// for
