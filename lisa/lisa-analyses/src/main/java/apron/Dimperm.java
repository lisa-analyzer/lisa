/*
 * Dimperm.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * A Dimperm object encapsulates an {@code ap_dimperm_t} Apron object allocated
 * in the C heap.
 */
public class Dimperm
	...
	public native void setElem(
			int i,
			int dim);

	/** Gets the variable index i is mapped to. */
	public native int getElem(
			int i);
