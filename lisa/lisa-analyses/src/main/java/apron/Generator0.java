/*
 * Generator0.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
 ...
 * <p>
 * A generator is a 0- or 1-dimensional affine feature of a polyhedron: a
 * vertex, a ray, or a line. Generator0 objects represent generators on level 0
 * abstract objects: variables are denoted by dimension (i.e., integer starting
 * from 0).
 * <p>
 * A Generator0 is represented as a (sparse or dense) linear expression, i.e., a
 * {@link apron.Linexpr0} expression where the constant coefficient is ignored
 * and all coefficients are scalar.
 */
public class Generator0
	 ...
	 * this is not changed.
	 */
	public Generator0 addDimensionsCopy(
			Dimchange c) {
	 ...
	 * this is not changed.
	 */
	public Generator0 permuteDimensionsCopy(
			Dimperm p) {
		Generator0 l = new Generator0(this);
