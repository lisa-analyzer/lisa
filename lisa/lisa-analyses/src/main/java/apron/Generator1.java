/*
 * Generator1.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
 ...
 * <p>
 * A Generator1 represents a 0- or 1-dimensional affine feature of a polyhedron
 * (vertex, ray, or line) over variables denoted by names in an environment.
 * <p>
 * A Generator1 is implemented as a pair containing a (sparse or dense)
 * {@link apron.Generator0} and an {@link apron.Environment}, manipulated in
...
public class Generator1
	...
	/**
	 * This function is used internally to construct a new level 1 generator by
	 * referencing a level 0 generator.
	 * <p>
	 * The level 0 generator should no longer be used afterwards.
	 */
	static public Generator1 make(
			Environment v,
			Generator0 x) {
	...
	/**
	 * Returns a (read-only) reference to the Generator0 underlying this
	 * generator.
	 * <p>
	 * Warning: it is dangerous to add coefficients, resize the generator, add,
	 * remove, or permute dimensions as it may desynchrnonize the Generator0
	 * dimensions form the environment.
	 */
	 ...
	 */
	public Generator1 extendEnvironmentCopy(
			Environment e) {
