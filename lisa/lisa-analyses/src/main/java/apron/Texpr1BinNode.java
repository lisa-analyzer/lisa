/*
 * Texpr1BinNode.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
...
/**
 * Class of binary operator nodes in {@link apron.Texpr1Node} level 1 expression
 * trees.
 */
public class Texpr1BinNode
	...
	public String toString() {
		...
		String suf = (rtype == RTYPE_REAL) ? ""
				: ("_" + Texpr0Node.suffixRType(rtype) + "," + Texpr0Node.suffixRDir(rdir));
