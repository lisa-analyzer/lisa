/*
 * Texpr1VarNode.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
...
/**
 * Class of variable leaves in {@link apron.Texpr1Node} level 1 expression
 * trees.
 * <p>
...
public class Texpr1VarNode
	...
	public boolean isEqual(
			Texpr1Node t) {
		return (t instanceof Texpr1VarNode) &&
