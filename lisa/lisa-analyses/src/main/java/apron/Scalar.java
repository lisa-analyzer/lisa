/*
 * Scalar.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * A Scalar object may be an arbitrary-precision fraction (stored into a
 * {@link apron.MpqScalar}), a double (stored in a {@link apron.DoubleScalar}),
 * or an arbitrary-precision float (stored in a {@link apron.MpfrScalar}). The
 * Scalar class provides methods to manipulate them independently from the
 * underlying representation. It is also a specialisation of the more general
 * {@link apron.Coeff} class to coefficients that are singleton.
 * <p>
...
abstract public class Scalar
	 ...
	 * <p>
	 * The result is +oo if sign is strictly positive, -oo if sign is strictly
	 * negative, 0 if sign is null.
	 */
	abstract public void setInfty(
			int sign);
