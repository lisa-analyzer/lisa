/*
 * Coeff.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * A coefficient can be either a {@link apron.Scalar} real singleton or an
 * {@link apron.Interval} set of real values. The Coeff class provides methods
 * to manipulate coefficients independently from the underlying representation.
 */
