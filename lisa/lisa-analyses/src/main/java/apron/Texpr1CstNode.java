/*
 * Texpr1CstNode.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
...
/**
 * Class of constant leaves in {@link apron.Texpr1Node} level 1 expression
 * trees.
 * <p>
...
public class Texpr1CstNode
	...
	public boolean isEqual(
			Texpr1Node t) {
		return (t instanceof Texpr1CstNode) &&
