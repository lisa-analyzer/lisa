/*
 * Linterm0.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * A Linterm0 is a pair composed of a {@link apron.Coeff} coefficient and a
 * variable denoted by dimension (i.e., integer starting from 0). It represents
 * a single term in a {@link apron.Linexpr0} or {@link apron.Lincons0}.
 */
public class Linterm0
	...
	public String toString(
			Var[] names) {
		if (names == null)
			return coeff.toString() + "x" + dim;
		else
			return coeff.toString() + names[dim].toString();
	}
	...
	public String toString(
		...
		if (names == null)
			...
			return coeff.toString() + names[dim];
	}
