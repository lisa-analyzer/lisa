/*
 * Test.java APRON Library / Java Apron binding Copyright (C) Antoine Mine' 2010
 */
...
public class Test {
	...
	public static Object testSerialize(
			Object o) {
		try {
	...
	public static void testDomain(
		...
		Linterm0[] ltrms = { new Linterm0(1, new MpqScalar(-5)),
		...
		Linterm0[] ltrms2 = { new Linterm0(1, new MpqScalar(-5)),
		...
		Linterm1[] xltrms = { new Linterm1("z", new MpqScalar(-5)),
		...
		Linterm1[] xltrms2 = { new Linterm1("a", new MpqScalar(-5)),
	...
	public static void mainx(
		 ...
		 * PolkaGrid(false)); System.out.println(""); testDomain(new
		 * PolkaGrid(true));
		 */
	}
