/*
 * Dimchange.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * A Dimchange object specifies how many and which dimensions to add to or to
 * remove from a level 0 object ({@link apron.Abstract0}, etc.).
 * <p>
 * A Dimchange object encapsulates a {@code ap_dimchange_t} Apron object
...
public class Dimchange
	 ...
	 * Creates a Dimchange.
	 * <p>
	 * The Dimchange object adds or removes intdim integer-valued and realdim
	 * real-valued dimensions. The array dim[], of size intdim+realdim,
	 * specifies the position of dimensions to add or remove.
	 * <p>
	 * When used to add dimensions, dim[i]=k indicates to add one dimension at
	 * position k and shift (increment) the dimensions greater than or equal to
	 * k.
	 * <p>
	 * When used to remove dimensions, dim[i]=k indicates to remove the
	...
	/**
	 * Returns the number of integer-valued and real-valued variables to be
	 * added or removed.
	 */
	...
	/**
	 * Indicates which dimension i is mapped to, assuming this is used to add
	 * dimensions.
	 */
	public native int afterAdd(
			int i);

	/**
	 * Indicates which dimension i is mapped to, assuming this is used to remove
	 * dimensions.
	 * <p>
	 * Returns -1 if the variable index would be removed.
	 */
	public native int afterRemove(
			int i);

	/**
	 * Inverts this.
	 * <p>
	 * Assuming that this is used to add some variables then, after inversion,
	 * it can be used to remove variables and recover the original variable set.
	 */
