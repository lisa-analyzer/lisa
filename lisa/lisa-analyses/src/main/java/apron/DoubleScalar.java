/*
 * DoubleScalar.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
...
/**
 * Class of Scalar objects backed up by a double-precision floating-point
 * number.
 */
