/*
 * Texpr0CstNode.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
...
/**
 * Class of constant leaves in {@link apron.Texpr0Node} level 0 expression
 * trees.
 * <p>
 * A constant value is represented by a {@link apron.Coeff} object.
 */
public class Texpr0CstNode
	...
	public boolean isEqual(
			Texpr0Node t) {
		return (t instanceof Texpr0CstNode) &&
