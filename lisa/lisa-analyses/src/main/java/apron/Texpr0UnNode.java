/*
 * Texpr0UnNode.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
...
/**
 * Class of unary operator nodes in {@link apron.Texpr0Node} level 0 expression
 * trees.
 */
public class Texpr0UnNode
	...
	static public String opName(
		...
		case OP_SQRT:
			return "sqrt";
		default:
			throw new IllegalArgumentException("unknown unary operation: " + op);
		}
	}
	...
	/**
	 * Creates a new unary operator node, with the specified operator, rounding
	 * type, rounding direction, and argument.
	 * <p>
	...
	/**
	 * Creates a new unary operator node, with the specified operator, and
	 * argument, and no rounding.
	 * <p>
	 * The subtree argument is referenced, not copied.
	 */
	public Texpr0UnNode(
	...
	public String toString(
		...
		if (arg.getPrecedence() > opPrecedence(op))
			return o + suf + a;
		else
			return o + suf + "(" + a + ")";
	}
