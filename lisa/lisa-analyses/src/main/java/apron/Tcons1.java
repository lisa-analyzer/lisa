/*
 * Tcons1.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * A Tcons1 represents a constraint over variables denoted by name in an
 * environment.
 * <p>
 * A Tcons1 is implemented as a pair containing a {@link apron.Tcons0} and an
 * {@link apron.Environment}, manipulated in conjunction. Direct access to the
 * fields is prohibited, to avoid desynchronizing them.
 */
public class Tcons1
		implements
		Cloneable,
	...
	/**
	 * This function is used internally to construct a level 1 constraint by
	 * referencing a level 0 constraint.
	 * <p>
	 * The level 0 constraint should no longer be used afterwards.
	 */
	static public Tcons1 make(
			Environment v,
			Tcons0 x) {
		Tcons1 r = new Tcons1();
		r.cons = x;
	 ...
	 * desynchrnonize the Tcons0 dimensions form the environment.
	 */
	 ...
	 * this is not modified.
	 */
	public Tcons1 extendEnvironmentCopy(
			Environment e) {
