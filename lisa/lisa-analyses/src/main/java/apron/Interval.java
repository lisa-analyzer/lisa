/*
 * Interval.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * Intervals are a specialisation of the more general {@link apron.Coeff} class.
 * <p>
 * Intervals may be unbounded (one or both bound(s) can be infinite). An
 * interval can also be empty (the canonical empty interval is [1, -1]).
 */
public class Interval
	 ...
	 *
	 * @return 0 is this = x, -1 if this is included in x, +1 if this contains
	 *             x, -2 if the lower bound of this is smaller than that of x,
	...
	public boolean isEqual(
			Interval x) {
		return (inf.isEqual(x.inf) && sup.isEqual(x.sup)) ||
				(isBottom() && x.isBottom());
	}
