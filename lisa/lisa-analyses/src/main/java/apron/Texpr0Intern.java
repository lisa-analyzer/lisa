/*
 * Texpr0Intern.java APRON Library / Java Apron binding Copyright (C) Antoine
 * Mine' 2010
 */
 ...
 * <p>
 * A Texpr0Intern represents an expression tree, with unary and binary operator
 * nodes, and {@link apron.Coeff} constant and variables (represented by
 * dimension) leaves.
 * <p>
 * A Texpr0Intern encapsulates an Apron {@code ap_texpr0_t} object, an opaque
...
public class Texpr0Intern
	...
	public Texpr0Intern addDimensionsCopy(
			Dimchange c) {
		Texpr0Intern x = new Texpr0Intern(this);
		x.addDimensions(c);
		return x;
	...
	public Texpr0Intern removeDimensionsCopy(
			Dimchange c) {
		Texpr0Intern x = new Texpr0Intern(this);
	...
	public Texpr0Intern permuteDimensionsCopy(
			Dimperm p) {
		Texpr0Intern x = new Texpr0Intern(this);
