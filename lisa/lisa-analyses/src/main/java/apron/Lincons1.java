/*
 * Lincons1.java APRON Library / Java Apron binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * A Lincons1 represents a linear constraint over variables denoted by names in
 * an environment.
 * <p>
 * A Lincons1 is implemented as a pair containing a (sparse or dense)
 * {@link apron.Lincons0} and an {@link apron.Environment}, manipulated in
...
public class Lincons1
	...
	/**
	 * <p>
	 * Returns a (read-only) reference to the Lincons0 underlying this
	 * constraint.
	 * <p>
	 * Warning: it is dangerous to add coefficients, resize the constraint, add,
	 * remove, or permute dimensions as it may desynchrnonize the Lincons0
	 ...
	 */
	public Lincons1 extendEnvironmentCopy(
			Environment e) {
