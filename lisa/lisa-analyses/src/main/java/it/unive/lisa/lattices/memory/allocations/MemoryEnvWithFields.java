...
public class MemoryEnvWithFields
		extends
		FunctionalLattice<MemoryEnvWithFields, Identifier, AllocationSites>
		implements
		MemoryLattice<MemoryEnvWithFields> {
	...
	@Override
	public Pair<MemoryEnvWithFields, List<MemoryReplacement>> pushScope(
			ScopeToken scope,
			ProgramPoint pp)
			throws SemanticException {
		AtomicReference<SemanticException> holder = new AtomicReference<>();

		Pair<MemoryEnvWithFields, List<MemoryReplacement>> result = liftIdentifiers(id -> {
			try {
		...
		MemoryReplacement base = result.getRight().get(result.getRight().size() - 1);
	...
	@Override
	public Pair<MemoryEnvWithFields, List<MemoryReplacement>> popScope(
			ScopeToken scope,
			ProgramPoint pp)
			throws SemanticException {
		AtomicReference<SemanticException> holder = new AtomicReference<>();
	...
	private Pair<MemoryEnvWithFields, List<MemoryReplacement>> liftIdentifiers(
	...
	@Override
	public Pair<MemoryEnvWithFields, List<MemoryReplacement>> forgetIdentifier(
			Identifier id,
			ProgramPoint pp)
			throws SemanticException {
	...
	@Override
	public Pair<MemoryEnvWithFields, List<MemoryReplacement>> forgetIdentifiers(
	...
	@Override
	public Pair<MemoryEnvWithFields, List<MemoryReplacement>> forgetIdentifiersIf(
	...
	@Override
	public MemoryEnvWithFields lubAux(
			MemoryEnvWithFields other)
			throws SemanticException {
		MemoryEnvWithFields lub = super.lubAux(other);
		return new MemoryEnvWithFields(lub.lattice, lub.function, fields.lub(other.fields));
	}

	@Override
	public MemoryEnvWithFields upchainAux(
			MemoryEnvWithFields other)
			throws SemanticException {
		MemoryEnvWithFields chain = super.upchainAux(other);
		return new MemoryEnvWithFields(chain.lattice, chain.function, fields.upchain(other.fields));
	}

	@Override
	public MemoryEnvWithFields glbAux(
			MemoryEnvWithFields other)
			throws SemanticException {
		MemoryEnvWithFields glb = super.glbAux(other);
		return new MemoryEnvWithFields(glb.lattice, glb.function, fields.glb(other.fields));
	}

	@Override
	public MemoryEnvWithFields downchainAux(
			MemoryEnvWithFields other)
			throws SemanticException {
		MemoryEnvWithFields chain = super.downchainAux(other);
		return new MemoryEnvWithFields(chain.lattice, chain.function, fields.downchain(other.fields));
	}
	...
	@Override
	public MemoryEnvWithFields top() {
		return isTop() ? this : new MemoryEnvWithFields(lattice.top(), null, fields.top());
	}
	...
	@Override
	public MemoryEnvWithFields bottom() {
		return isBottom() ? this : new MemoryEnvWithFields(lattice.bottom(), null, fields.bottom());
	}
	...
	public List<MemoryReplacement> expand(
			...
			throws SemanticException {
		MemoryReplacement sub = new MemoryReplacement();
	...
	public boolean equals(
		...
		if (getClass() != obj.getClass())
			return false;
		MemoryEnvWithFields other = (MemoryEnvWithFields) obj;
		if (fields == null) {
