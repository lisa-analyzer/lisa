...
/**
 * This abstract class generalize the concept of an abstract domain whose domain is the finite non redundant subset 
 * of the domain of another lattice (in this case the other lattice is of type E). This implementation follows 
 * the guidelines of this <a href="https://www.cs.unipr.it/Publications/PDF/Q349.pdf">paper</a>. 
 * It is implemented as a {@link BaseNonRelationalValueDomain}, handling top and bottom values for
...
public abstract class NonRedundantPowersetOfBaseNonRelationalValueDomain
	...
	/**
	 * The underlying {@link BaseNonRelationalValueDomain} by which it can be possible to retrieve top and bottom elements.
	 */
	 ...
	 *                lattice instance
	 * 
	 * @return a new concrete instance of {@link NonRedundantPowerset} containing the
	 ...
	 * Given a subset S of a domain of a lattice: 
	 * &#937;(S) = S \ {s &ni; S | ( s = bottom ) &vee; ( &exist; s' &ni; S. s &le; s' )}
	 *
	 * 
	 ...
	 * Two elements of a set are overlapping iff their glb is not bottom. It uses an auxiliary method removeOverlappingBetweenElelements that knows 
	 * how to remove the overlapping between two elements of type E.
	 * 
	 * @return an equivalent set of elements that doesn't have overlapping elements.
	 * 
	 * @throws SemanticException if an error occurs during the computation
	 */
	...
	/**
	 * Yields a new element equivalent to the two overlapping elements e1 and e2. By default it calculates the lub between the two elements.
	 * But if exist a better method that looses less information it can be implemented in the concrete class.
	 * 
