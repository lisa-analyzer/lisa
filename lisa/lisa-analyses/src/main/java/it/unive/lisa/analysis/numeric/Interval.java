 ...
 * is {@link IntInterval}. Arithmetic operators are evaluated through interval
 * arithmetic (e.g., the sum of two intervals is the interval of their bounds'
 * sums), comparisons are evaluated by checking whether the two intervals
 * overlap, and, when a
 * {@link it.unive.lisa.analysis.combination.constraints.WholeValueAnalysis} is
 * available, some non-arithmetic operators (e.g., string-related ones such as
 * {@link StringLength}) are refined through the constraints generated by other
 * domains instead of being approximated to top.
 *
 * @author <a href="mailto:luca.negrini@unive.it">Luca Negrini</a>
 *
 * @see <a href="https://www.di.ens.fr/~cousot/COUSOTpapers/ISOP76.shtml">
 *          Patrick Cousot, Radhia Cousot. Static Determination of Dynamic
 *          Properties of Programs. In Proceedings of the Second International
 *          Symposium on Programming, pages 106-130, Dunod, Paris, 1976.</a>
 */
