...
public class TwoLevelsTaint
	 ...
	 * @author <a href="mailto:luca.negrini@unive.it">Luca Negrini</a>
	 */
	public static class SimpleTaint
			implements
			TaintLattice<SimpleTaint> {

		/**
		 * The tainted instance of this taint lattice, representing values that
		 * are possibly tainted. This also serves as the top element of this
		 * lattice.
		 */
		public static final SimpleTaint TAINTED = new SimpleTaint(true);

		/**
		 * The clean instance of this taint lattice, representing values that
		 * are always clean.
		 */
