...
/**
 * A {@link BaseTaint} implementation with three levels of taintedness,
 * represented by {@link ThreeTaint}: clean, tainted, and top. As such, this
 * class distinguishes values that are always clean, always tainted, or tainted
 * in at least one execution path (top) from values about which nothing is known
 * (bottom). <br/>
 * <br/>
