/*
 * Mpq.java APRON Library / Java GMP/MPFR binding Copyright (C) Antoine Mine'
 * 2010
 */
 ...
 * <p>
 * This class wraps {@code mpq_t} GMP objects.
 */
public class Mpq
		implements
		Serializable,
	 ...
	 * <p>
	 * Removes common factors in the numerator and denominator, and makes the
	 * denominator positive.
	 * <p>
	 * All arithmetic functions assume and return canonical fractions. However,
	 * pure assignment functions (including separate assignments of denominators
	 * and numerators, directly or through a {@link MpzRef} reference) do not
	 * canonicalize the assigned object, and so, the function must be called by
	 * the user before arithmetic operations can be performed.
	 */
	 ...
	 * <p>
	 * {@link #canonicalize} must be called manually if the fraction is not
	 * canonical.
	 */
	public native void set(
			Mpz num,
	 ...
	 * <p>
	 * This method is faster than calling cmp, as fractions are assumed to be
	 * canonical.
	 */
	...
	private void writeObject(
			...
			throws IOException {
		/*
		 * format: - Mpz numerator - Mpz denominator
		 */
