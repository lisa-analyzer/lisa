...
/**
 * Class of references to numerators and denominator of {@link Mpq}
 * objects.
 *
 ...
 * A MpzRef to reference the numerator or the denominator of a {@link Mpq}
 * object can be obtained using the {@link Mpq#numRef} and
 * {@link Mpq#denRef} methods.
 * The MpzRef can then be manipulated exactly as a {@link Mpz}, from which
 * it inherits all methods.
 * This allows manipulating {@link Mpq} numerators and denominators
...
{
    /**
     * We keep a pointer to the parent {@link Mpq} object so that it is
