 ...
 * Instances of this literal have a {@link UInt32Type} static type. Internally,
 * the constant is stored in a (signed) {@code int}.
 * 
...
public class UInt32Literal
	...
	@Override
	public UInt32Literal clone(
			CloneLocator locator) {
		return new UInt32Literal(getCFG(), locator.locationFor(this), getValue().intValue());
	}
