...
public class ModuloTest {
	...
	private Modulo modulo() {
		...
		return new Modulo(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheModuloOperatorAndDelegatesToSmallStepSemantics()
		...
		assertEquals(NumericNonOverflowingMod.INSTANCE, built.getOperator());
	...
	@Test
	public void leftOperandNotNumericYieldsBottomWithoutComputingTheModulo()
			throws SemanticException {
		Modulo div = modulo();
	...
	@Test
	public void rightOperandNotNumericYieldsBottomWithoutComputingTheModulo()
			throws SemanticException {
		Modulo div = modulo();
		domain.setRuntimeTypes(leftOperand, Set.of(Int32Type.INSTANCE));
