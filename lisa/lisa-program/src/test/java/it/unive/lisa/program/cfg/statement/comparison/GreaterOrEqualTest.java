...
public class GreaterOrEqualTest {
	...
	private GreaterOrEqual greaterOrEqual() {
		...
		return new GreaterOrEqual(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheGreaterOrEqualOperatorAndDelegatesToSmallStepSemantics()
			throws SemanticException {
		GreaterOrEqual gt = greaterOrEqual();
		...
		AnalysisState<UnitLattice> result = gt.fwdBinarySemantics(
		...
		assertEquals(ComparisonGe.INSTANCE, built.getOperator());
		...
		assertEquals(gt.getLocation(), built.getCodeLocation());
	...
	@Test
	public void leftOperandNotNumericYieldsBottomWithoutComputingTheComparison()
			throws SemanticException {
		GreaterOrEqual gt = greaterOrEqual();
	...
	@Test
	public void rightOperandNotNumericYieldsBottomWithoutComputingTheComparison()
			throws SemanticException {
		GreaterOrEqual gt = greaterOrEqual();
		domain.setRuntimeTypes(leftOperand, Set.of(Int32Type.INSTANCE));
