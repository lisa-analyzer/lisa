...
public class StartsWithTest {
	...
	private StartsWith startsWith() {
		...
		return new StartsWith(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsStringBuildsTheStartsWithOperatorAndDelegatesToSmallStepSemantics()
		...
		AnalysisState<UnitLattice> result = startsWith.fwdBinarySemantics(
		...
		assertEquals(StringStartsWith.INSTANCE, built.getOperator());
		assertEquals(startsWith.getStaticType(), built.getStaticType());
	...
	@Test
	public void leftOperandNotStringYieldsBottomWithoutComputingTheStartsWith()
			throws SemanticException {
		StartsWith startsWith = startsWith();
	...
	@Test
	public void rightOperandNotStringYieldsBottomWithoutComputingTheStartsWith()
			throws SemanticException {
		StartsWith startsWith = startsWith();
		domain.setRuntimeTypes(leftOperand, Set.of(StringType.INSTANCE));
