...
public class ReplaceTest {
	...
	private Replace replace() {
		...
		return new Replace(TestFixtures.CFG, TestFixtures.LOCATION, left, middle, right);
	}

	@Test
	public void allThreeOperandsStringBuildsTheReplaceOperatorAndDelegatesToSmallStepSemantics()
		...
		AnalysisState<UnitLattice> result = replace.fwdTernarySemantics(
		...
		assertEquals(StringReplace.INSTANCE, built.getOperator());
		assertEquals(replace.getStaticType(), built.getStaticType());
	...
	@Test
	public void leftOperandNotStringYieldsBottomWithoutComputingTheReplace()
			throws SemanticException {
		Replace replace = replace();
	...
	@Test
	public void middleOperandNotStringYieldsBottomWithoutComputingTheReplace()
			throws SemanticException {
		Replace replace = replace();
		domain.setRuntimeTypes(leftOperand, Set.of(StringType.INSTANCE));
	...
	@Test
	public void rightOperandNotStringYieldsBottomWithoutComputingTheReplace()
			throws SemanticException {
		Replace replace = replace();
		domain.setRuntimeTypes(leftOperand, Set.of(StringType.INSTANCE));
		domain.setRuntimeTypes(middleOperand, Set.of(StringType.INSTANCE));
