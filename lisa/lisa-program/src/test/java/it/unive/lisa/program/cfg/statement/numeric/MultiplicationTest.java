...
public class MultiplicationTest {
	...
	private Multiplication multiplication() {
		...
		return new Multiplication(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheMultiplicationOperatorAndDelegatesToSmallStepSemantics()
			throws SemanticException {
		Multiplication div = multiplication();
		...
		assertEquals(NumericNonOverflowingMul.INSTANCE, built.getOperator());
	...
	@Test
	public void leftOperandNotNumericYieldsBottomWithoutComputingTheMultiplication()
			throws SemanticException {
		Multiplication div = multiplication();
	...
	@Test
	public void rightOperandNotNumericYieldsBottomWithoutComputingTheMultiplication()
			throws SemanticException {
		Multiplication div = multiplication();
		domain.setRuntimeTypes(leftOperand, Set.of(Int32Type.INSTANCE));
