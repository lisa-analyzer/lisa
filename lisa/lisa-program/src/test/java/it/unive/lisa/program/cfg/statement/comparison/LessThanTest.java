...
public class LessThanTest {
	...
	private LessThan lessThan() {
		...
		return new LessThan(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheLessThanOperatorAndDelegatesToSmallStepSemantics()
			throws SemanticException {
		LessThan gt = lessThan();
		...
		assertEquals(ComparisonLt.INSTANCE, built.getOperator());
