...
public class EqualsTest {
	...
	private Equals equalsStmt() {
		...
		return new Equals(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsStringBuildsTheEqualsOperatorAndDelegatesToSmallStepSemantics()
			throws SemanticException {
		Equals eq = equalsStmt();
		...
		assertEquals(StringEquals.INSTANCE, built.getOperator());
		assertEquals(eq.getStaticType(), built.getStaticType());
	...
	@Test
	public void leftOperandNotStringYieldsBottomWithoutComputingTheEquals()
			throws SemanticException {
		Equals eq = equalsStmt();
	...
	@Test
	public void rightOperandNotStringYieldsBottomWithoutComputingTheEquals()
			throws SemanticException {
		Equals eq = equalsStmt();
		domain.setRuntimeTypes(leftOperand, Set.of(StringType.INSTANCE));
