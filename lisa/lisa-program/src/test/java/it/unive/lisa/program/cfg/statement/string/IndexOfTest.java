...
public class IndexOfTest {
	...
	private IndexOf indexOf() {
		...
		return new IndexOf(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsStringBuildsTheIndexOfOperatorAndDelegatesToSmallStepSemantics()
		...
		AnalysisState<UnitLattice> result = indexOf.fwdBinarySemantics(
		...
		assertEquals(StringIndexOf.INSTANCE, built.getOperator());
		assertEquals(indexOf.getStaticType(), built.getStaticType());
	...
	@Test
	public void leftOperandNotStringYieldsBottomWithoutComputingTheIndexOf()
			throws SemanticException {
		IndexOf indexOf = indexOf();
	...
	@Test
	public void rightOperandNotStringYieldsBottomWithoutComputingTheIndexOf()
			throws SemanticException {
		IndexOf indexOf = indexOf();
		domain.setRuntimeTypes(leftOperand, Set.of(StringType.INSTANCE));
