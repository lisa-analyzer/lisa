...
public class OrTest {
	...
	private Or or() {
		...
		return new Or(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsBooleanBuildsTheOrOperatorAndDelegatesToSmallStepSemantics()
		...
		AnalysisState<UnitLattice> result = or.fwdBinarySemantics(
		...
		assertEquals(LogicalOr.INSTANCE, built.getOperator());
		assertEquals(or.getStaticType(), built.getStaticType());
	...
	@Test
	public void leftOperandNotBooleanYieldsBottomWithoutComputingTheOr()
			throws SemanticException {
		Or or = or();
	...
	@Test
	public void rightOperandNotBooleanYieldsBottomWithoutComputingTheOr()
			throws SemanticException {
		Or or = or();
		domain.setRuntimeTypes(leftOperand, Set.of(BoolType.INSTANCE));
