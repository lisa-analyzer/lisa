...
public class SubtractionTest {
	...
	private Subtraction subtraction() {
		...
		return new Subtraction(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheSubtractionOperatorAndDelegatesToSmallStepSemantics()
			throws SemanticException {
		Subtraction div = subtraction();
		...
		assertEquals(NumericNonOverflowingSub.INSTANCE, built.getOperator());
	...
	@Test
	public void leftOperandNotNumericYieldsBottomWithoutComputingTheSubtraction()
			throws SemanticException {
		Subtraction div = subtraction();
	...
	@Test
	public void rightOperandNotNumericYieldsBottomWithoutComputingTheSubtraction()
			throws SemanticException {
		Subtraction div = subtraction();
		domain.setRuntimeTypes(leftOperand, Set.of(Int32Type.INSTANCE));
