...
public class LessOrEqualTest {
	...
	private LessOrEqual lessOrEqual() {
		...
		return new LessOrEqual(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheLessOrEqualOperatorAndDelegatesToSmallStepSemantics()
			throws SemanticException {
		LessOrEqual gt = lessOrEqual();
		...
		assertEquals(ComparisonLe.INSTANCE, built.getOperator());
