...
public class RemainderTest {
	...
	private Remainder remainder() {
		...
		return new Remainder(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheRemainderOperatorAndDelegatesToSmallStepSemantics()
		...
		assertEquals(NumericNonOverflowingRem.INSTANCE, built.getOperator());
	...
	@Test
	public void leftOperandNotNumericYieldsBottomWithoutComputingTheRemainder()
			throws SemanticException {
		Remainder div = remainder();
	...
	@Test
	public void rightOperandNotNumericYieldsBottomWithoutComputingTheRemainder()
			throws SemanticException {
		Remainder div = remainder();
		domain.setRuntimeTypes(leftOperand, Set.of(Int32Type.INSTANCE));
