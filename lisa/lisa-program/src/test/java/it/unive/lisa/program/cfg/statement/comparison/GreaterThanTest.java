...
public class GreaterThanTest {
	...
	private GreaterThan greaterThan() {
		...
		return new GreaterThan(TestFixtures.CFG, TestFixtures.LOCATION, left, right);
	}

	@Test
	public void bothOperandsNumericBuildsTheGreaterThanOperatorAndDelegatesToSmallStepSemantics()
		...
		assertEquals(ComparisonGt.INSTANCE, built.getOperator());
