...
public class ValidateString {
	...
	// Automaton dfa = new Automaton(states, transitions, initialStates,
	// finalStates);
	//
	...
	// states.add(st[0]);
	// states.add(st[1]);
	// initialStates.add(st[0]);
	// finalStates.add(st[1]);
	//
	// Set<Transition> transitions = new HashSet<>();
	// transitions.add(new Transition(st[0], st[0], 'a'));
	...
	// Automaton nfa = new Automaton(states, transitions, initialStates,
	// finalStates);
	//
