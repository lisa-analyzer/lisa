...
public class LiSARunner<A extends AbstractState<A, H, V, T>,
	...
	private HtmlGraphNavigator nav;
	 ...
	 */
	Collection<Warning> run(Program program, FileManager fileManager) throws IOException {
		finalizeProgram(program);

		Collection<CFG> allCFGs = program.getAllCFGs();

		this.nav = new HtmlGraphNavigator(program);
