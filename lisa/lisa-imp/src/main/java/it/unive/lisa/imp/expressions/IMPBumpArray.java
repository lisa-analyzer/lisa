...
/**
 * An expression modeling the array static allocation operation
 ...
 */
public class IMPBumpArray extends NaryExpression {
	 ...
	 */
	public IMPBumpArray(CFG cfg, String sourceFile, int line, int col, Type type, Expression[] dimensions) {
