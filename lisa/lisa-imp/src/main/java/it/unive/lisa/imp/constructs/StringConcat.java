...
public class StringConcat extends NativeCFG {
	...
	public static class IMPStringConcat extends Concat implements PluggableStatement {
		 ...
		 */
		public static IMPStringConcat build(ImplementedCFG cfg, CodeLocation location, Expression... params) {
		 ...
		 */
		public IMPStringConcat(ImplementedCFG cfg, String sourceFile, int line, int col, Expression left,
				Expression right) {
		 ...
		 * @param right    the right-hand side of this operation
		 */
		public IMPStringConcat(ImplementedCFG cfg, CodeLocation location, Expression left, Expression right) {
