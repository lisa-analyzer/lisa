...
/**
 * An expression modeling the object static allocation and initialization
 * operation ({@code bump className(...)}). The type of this expression is the
 ...
 */
public class IMPBumpObj extends NaryExpression {

	/**
	 * Builds the object static allocation and initialization.
	 * 
	 ...
	 */
	public IMPBumpObj(CFG cfg, String sourceFile, int line, int col, Type type, Expression... parameters) {
